...
module.exports = {
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
    "./node_modules/@tremor/**/*.{js,ts,jsx,tsx}", // for Tremor components
  ],
  theme: {
    ...
    extend: {
      colors: {
        ...
        // TODO: Add dark mode theme colors
      },
      boxShadow: {
  ...
  /* 
    This is to prevent Tailwind from purging dynamically generated classes from Tremor.
    Without this, all the color variations for components like <Badge> would be missing.
  */
  safelist: [
    {
